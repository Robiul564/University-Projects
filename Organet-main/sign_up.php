...
<style>
    ...
    button {
        ...
        font-weight: 500;
        color: white;
        border: 3px solid #0b519c;
        border-radius: 8px;
        box-shadow: 0 0 0 #95c4ff;
...
<div class="container p-0">
    ...
    <div class="right-section">
      ...
      <defs></defs>
                ...
                <p class="text">with<br /><br />SOCIAL</p>
                <div class="main_back"></div>
            </div>

<!--            <div class="ssgoogle">-->
<!--                <div class="google-signup"><img src="/assets/img/google.png"></div>-->
<!--            </div>-->

            <p class="or">or</p>

            <form id="signup-form" onsubmit="event.preventDefault(); Register();">
...
<script>
    async function Register() {
        ...
        try {
            const response = await axios.post('/api/or_register.php', formData);
