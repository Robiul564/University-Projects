...
<style>
    ...
    .front {
        ...
        position: relative;
        border-radius: 6px; /* Slightly smaller radius */
        background: hsl(213, 49%, 54%);
        padding: 6px 40px; /* Increased width with more horizontal padding */
        color: white;
        font-weight: 400;
        text-transform: uppercase;
        letter-spacing: 1.8px; /* Slightly reduced spacing */
...
<div class="container" style="padding-right: 0;padding-left: 0;">
    <div class="left-section">
        ...
        <p class="message">Use these awesome forms to log in or create a new account in your project for free.</p>
    </div>
    <div class="right-section">
        <div class="form-container">
            ...
            <div>
                <ul class="example-2" style="padding-left: 0;">
        ...
        ></path>
            ...
            <div style="margin-bottom: 20px"><span>or</span></div>
            <form id="login-form" onsubmit="event.preventDefault(); Login();">
                ...
                <button type="submit" class="btn btn-primary pushable" style="margin-left:-15px">
            ...
            <p class="signin-link">Forget Password? <a href="/forgot_pass.php">Reset</a></p>
        </div>
    </div>
</div>
...
<script>
    async function Login() {
        ...
        try {
            const response = await axios.post('/api/or_login.php', formData);
